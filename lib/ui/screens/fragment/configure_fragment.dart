...
class ConfigureFragment extends StatefulWidget {
  const ConfigureFragment({super.key});

  @override
  State<ConfigureFragment> createState() => _ConfigureFragmentState();
}

class _ConfigureFragmentState extends State<ConfigureFragment> {
  ...
  void dispose() {
    _timer.cancel();
    _compassSubscription?.cancel(); // Batalkan subscription saat dispose
    super.dispose();
  }
